...
DEFAULT_PROJECT_DIR = Path((__import__("os").environ.get('KNOT_PROJECT_DIR', '/content/drive/MyDrive/consensus_hardness_refactored') + ''))
DEFAULT_DATA_DIR = Path((__import__("os").environ.get('KNOT_DATA_DIR', '/content/drive/MyDrive/Colab Notebooks/data_invariants/Invariants') + ''))
